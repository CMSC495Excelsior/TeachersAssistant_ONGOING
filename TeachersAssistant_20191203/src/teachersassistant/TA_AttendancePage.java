...
public class TA_AttendancePage {
    ...
    private static GridPane makeGridPane(){
        ...
        presentLabel2 = TA_ConvenienceMethods.createLabel(presentLabel2, "Pres", Double.MAX_VALUE, Pos.CENTER, "Arial", FontWeight.BOLD, 10);
        
        Label absentLabel2 = null;
        absentLabel2 = TA_ConvenienceMethods.createLabel(absentLabel2, "Abs.", Double.MAX_VALUE, Pos.CENTER, "Arial", FontWeight.BOLD, 10);
        
        Label tardyLabel2 = null;
        tardyLabel2 = TA_ConvenienceMethods.createLabel(tardyLabel2, "Tar.", Double.MAX_VALUE, Pos.CENTER, "Arial", FontWeight.BOLD, 10);
        ...
        for(Map.Entry<Integer, String> entry : studentNamesMap.entrySet()){
            ...
            switch(studentNamesMap.size()){
                case 1:
                    ...
                    //attendanceBoxLeft_TITLE.setPrefWidth(500);
                    //attendanceBoxRight_TITLE.setPrefWidth(500);
